...
if st.button('need help with url?', on_click=None):
    ...
    st.image(Image.open(img_paths[img_no]), caption='main page', width=750)
    st.image(Image.open(img_paths[img_no+1]), caption='rating page', width=750)
...
def user_input_features():
    ...
    if input_rating_url is None or input_rating_url == "":
        ...
        try:
            ...
            st.write("Please input informations by hand")
            raise Exception("Sorry, unable to get data from provided page url")
